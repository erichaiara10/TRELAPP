  ...
  return (
    <div className="container-tight py-14 max-w-3xl">
      ...
      <div className="prose mt-6 text-ink-700 leading-relaxed space-y-4">
        {kind === "terms" ? (
          <>
            <p>By using the PNG Realty website you agree to these terms. Content is provided for informational purposes and does not constitute a binding offer.</p>
            <p>Listings are believed to be accurate but should be independently verified. PNG Realty is not liable for errors, omissions, or third-party actions.</p>
          ...
          <>
            <p>PNG Realty collects contact information you submit via our forms (name, email, phone, requirements) for the sole purpose of servicing your enquiry.</p>
