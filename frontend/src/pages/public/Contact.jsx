    ...
    <div>
      <div className="container-tight pt-14 grid md:grid-cols-2 gap-10">
        <div>
          ...
          <h1 className="font-serif text-4xl sm:text-5xl mt-3">Get in touch</h1>
          <p className="text-ink-700 mt-4">
            Reach us during business hours (Mon–Fri, 8am–5pm PGT), or leave a message and
