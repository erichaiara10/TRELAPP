...
# ---- AI Nearby Amenities (Claude Sonnet 4.5 via Emergent LLM Key) ----
...
@api.post("/ai/nearby-amenities")
async def ai_nearby_amenities(payload: NearbyAmenitiesIn):
    """Public endpoint — returns a curated list of nearby amenities (schools,
    hospitals, shopping, beaches, transport, recreation) for a given property
