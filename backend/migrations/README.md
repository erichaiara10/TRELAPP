...
- Verify performs read-only checks for all 67 collections, all 38 intended index
  specifications, strict validators, the applied ledger checksum, and the
  178-document legacy baseline.
